      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{getTitle()}</h1>
            <p className="text-gray-600 dark:text-gray-400 mb-2">{getDescription()}</p>
            <p className="text-xs text-gray-500 dark:text-gray-500">Tangento Monitoring System</p>
          </div>
          ...
          <div className="mt-6 text-center">
            ...
            {countdown > 0 ? (
              <p className="text-gray-500 dark:text-gray-400 text-sm">Resend in {countdown}s</p>
            ) : (
              <button
