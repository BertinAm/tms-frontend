...
export default function ProfileClient() {
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      await axiosApiCall("/api/auth/profile", {
        method: "PUT",
        data: formData,
        headers: {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      await axiosApiCall("/api/auth/upload-profile-picture", {
        method: "POST",
        data: formData,
        headers: {
          Authorization: `Bearer ${isClient ? localStorage.getItem("access_token") : ""}`,
  ...
  return (
    <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
      ...
      {error && (
        <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-2 00 dark:border-red-800 rounded-lg">
        ...
        <div className="lg:col-span-1">
          <ComponentCard title="Profile Picture">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Click the camera icon to upload a new profile picture (Max 5MB)</p>
              <div className="mt-4">
                <Button onClick={handleImageUpload} disabled={loading || !profileImage} className="bg-primary-500 hover:bg-primary-600 text-white">
          ...
          <ComponentCard title="Account Statistics" className="mt-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">Active</span>
              </div>
            </div>
          </ComponentCard>
        </div>
          ...
          <ComponentCard title="Privacy & Security">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button className="bg-primary-500 hover:bg-primary-600 text-white text-sm px-4 py-2">Enable 2FA</Button>
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <Button className="bg-gray-500 hover:bg-gray-600 text-white text-sm px-4 py-2">View Sessions</Button>
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <Button className="bg-blue-500 hover:bg-blue-600 text-white text-sm px-4 py-2">Export Data</Button>
              </div>
            </div>
          </ComponentCard>
            ...
            <div className="border border-red-200 dark:border-red-800 rounded-lg p-4 bg-red-50 dark:bg-red-900/20">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-red-700 dark:text-red-400">Permanently delete your account and all associated data. This action cannot be undone.</p>
                </div>
                <Button onClick={handleDeleteAccount} disabled={loading} className="bg-red-500 hover:bg-red-600 text-white">
